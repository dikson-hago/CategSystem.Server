using Microsoft.ML;
using MlServer.Application.Models;

namespace MlServer.Application;

public class MlClass
{
    private string _appPath => Path.GetDirectoryName(Environment.GetCommandLineArgs()[0]);
    private string _trainDataPath => Path.Combine("C:\\Users\\User\\Documents\\учеба\\CourseWork\\MlServer\\MlServer.Application\\Data\\issues_train_easy.tsv");
    private string _testDataPath => Path.Combine("C:\\Users\\User\\Documents\\учеба\\CourseWork\\MlServer\\MlServer.Application\\Data\\issues_test.tsv");
    private string _modelPath => Path.Combine("C:\\Users\\User\\Documents\\учеба\\CourseWork\\MlServer\\MlServer.Application\\MlModels\\model.zip");
    
    private MLContext _mlContext;
    private PredictionEngine<PredictModel, Prediction> _predEngine;
    ...
    public void Run()
    {
        ...
        _trainingDataView = _mlContext.Data.LoadFromTextFile<PredictModel>(_trainDataPath, hasHeader: true);
        // </SnippetLoadTrainData>
    ...
    private IEstimator<ITransformer> BuildAndTrainModel(IDataView trainingDataView, IEstimator<ITransformer> pipeline)
        {
            ...
            _predEngine = _mlContext.Model.CreatePredictionEngine<PredictModel, Prediction>(_trainedModel);
            // </SnippetCreatePredictionEngine1>
            // <SnippetCreateTestIssue1>
            PredictModel issue = new PredictModel()
            {
    ...
    public void Evaluate(DataViewSchema trainingDataViewSchema)
        {
            ...
            var testDataView = _mlContext.Data.LoadFromTextFile<PredictModel>(_testDataPath, hasHeader: true);
            // </SnippetLoadTestDataset>
    ...
    private void PredictIssue()
    {
        ...
        // <SnippetAddTestIssue>
        PredictModel singleIssue = new PredictModel() 
        ...
        _predEngine = _mlContext.Model.CreatePredictionEngine<PredictModel, Prediction>(loadedModel);
        // </SnippetCreatePredictionEngine>
